...
var 
    ...
    ZSC = CCZnp.constants,
    nvItemIds = ZSC.SYS.nvItemIds;

var nvParams = {
    startupOption: { 
        id: nvItemIds.STARTUP_OPTION,     // 0x03
        offset: 0,
        len: 0x01,
        value: [ 0x00 ]
    },
    panId: {
        id: nvItemIds.PANID,              // 0x83
        offset: 0,
        len: 0x02,
        value: [ 0xFF, 0xFF ]
    },
    ...
    extPanId: {
        id: nvItemIds.EXTENDED_PAN_ID,    // 0x2D
        offset: 0,
        len: 0x08,
        value: [ 0xDD, 0xDD, 0xDD, 0xDD, 0xDD, 0xDD, 0xDD, 0xDD ]
    },
    channelList: {
        id: nvItemIds.CHANLIST,           // 0x84
        offset: 0,
        len: 0x04,
    ...
    logicalType: {
        id: nvItemIds.LOGICAL_TYPE,       // 0x87
        offset: 0,
        len: 0x01,
        value: [ 0x00 ]
    },
    nwkkey: {
        id: nvItemIds.NWKKEY,          // 0x82
        offset: 1,
        len: 0x10,
        value: [ 0x5a, 0x69, 0x67, 0x42, 0x65, 0x65, 0x41, 0x6c, 0x6c, 0x69, 0x61, 0x6e, 0x63, 0x65, 0x30, 0x39 ].reverse()
    },
    precfgkey: {
        id: nvItemIds.PRECFGKEY,          // 0x62
        offset: 0,
        len: 0x10,
        value: [ 0x01, 0x03, 0x05, 0x07, 0x09, 0x0B, 0x0D, 0x0F, 0x00, 0x02, 0x04, 0x06, 0x08, 0x0A, 0x0C, 0x0D ]
    },
    precfgkeysEnable: {
        id: nvItemIds.PRECFGKEYS_ENABLE,  // 0x63
        offset: 0,
        len: 0x01,
        value: [ 0x00 ]
    ...
    zdoDirectCb: {
        id: nvItemIds.ZDO_DIRECT_CB,      // 0x8F
        offset: 0,
        len: 0x01,
        value: [ 0x01 ]
    },
    tclkStart: {
        id: nvItemIds.TCLK_TABLE_START,        // 0x0111
        offset: 0x00,
        len: 0x20,
    ...
    znpCfgItem: {
        id: nvItemIds.ZNP_HAS_CONFIGURED,      // 0x0F00
        len: 0x01,
        initlen: 0x01,
        initvalue: [ 0x00 ]
    },
