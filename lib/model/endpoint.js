...
Endpoint.prototype.foundation = function(cId, cmd, zclData, cfg) {
    return this.shepherd._foundation(null, this, cId, cmd, zclData, cfg);
};
Endpoint.prototype.functional = function(cId, cmd, zclData, cfg) {
    return this.shepherd._functional(null, this, cId, cmd, zclData, cfg);
};
Endpoint.prototype.bind = function(cId, dstEpOrGrpId) {
    return this.shepherd.controller.bind(this, cId, dstEpOrGrpId);
};
Endpoint.prototype.unbind = function(cId, dstEpOrGrpId) {
    return this.shepherd.controller.unbind(this, cId, dstEpOrGrpId);
};
