...
class Device {
    ...
    static async get(id, keystore, shepherd){
        ...
        c = new Device(keystore, devInfo, shepherd)
        Device._db[id] = c
        return c
    }
    ...
    static async all(keystore, shepherd){
        ...
        for(const devInfo of all){
            ...
            if(!device){
                device = new Device(keystore, devInfo, shepherd)
